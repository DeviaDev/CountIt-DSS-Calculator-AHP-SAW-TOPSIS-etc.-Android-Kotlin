...
class TOPSISCalculator : SPKCalculator {
    override suspend fun calculate(
        ...
        // Implementasi TOPSIS akan ditambahkan di sini
        return createPlaceholderResult(SPKMethod.TOPSIS, alternatives, criteria, matrix)
    }
}
