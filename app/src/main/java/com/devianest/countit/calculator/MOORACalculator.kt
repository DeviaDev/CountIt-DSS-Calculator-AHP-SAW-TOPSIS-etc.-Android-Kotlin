...
class MOORACalculator : SPKCalculator {
    override suspend fun calculate(
        ...
        // Implementasi MOORA akan ditambahkan di sini
        return createPlaceholderResult(SPKMethod.MOORA, alternatives, criteria, matrix)
    }
}
